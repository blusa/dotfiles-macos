...
| Bugs | ThinkPad P14s, Win 11 | TS `100.105.30.76` + ZT | Spinlock modern apps. No SSH server yet (setup pending). RDP con cuenta AzureAD via `rdp/bugs.rdp` del repo dotfiles (web sign-in de Entra; hostname `BUGS`, no IP) |
